...
const OrderDetails = () => {
    ...
    const {route, noBottom, status, dinningOptions} = useLocalSearchParams();
    ...
    return (
        <View style={tw`gap-5 h-full`}>
            <AppBar title={'Order Details'} left={<BackBtn customOnPress={route ? () => router.push(route as any) : undefined}/>} right={<View style={tw`w-11`}/>}/>
