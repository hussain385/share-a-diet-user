...
import {Image, TouchableOpacity, View, TextInput, ScrollView, SafeAreaView} from "react-native";
        ...
        <SafeAreaView>
            <View style={tw`gap-5`}>
                <View style={[tw`relative -ml-[5.55%]`, {width: screen_width}]}>
                    ...
                    <BackBtn style={[tw`absolute left-5`, {top: isIOS() ? screen_height * 0.07 : 14}]}/>
                </View>
